...
useHead({
  ...
  meta: [
    ...
    },
    {
      property: 'og:url',
      content: ()=>{
        return 'https://www.ckjofficial.com/news/news-tooth-wiki/' + coverageDeatail.value.id
      },
    },
    {
      property: 'og:image',
          ...
          <div class="content-bdetail-in">
            <div class="context">
              ...
              <div class="righeBox">
                ...
                <a :href="`https://www.facebook.com/sharer/sharer.php?u=https://www.ckjofficial.com/news/news-tooth-wiki/${_nid}`" target="_block" class="facebook" title="分享facebook"></a>
              </div>
            </div>
            <div class="btn">
