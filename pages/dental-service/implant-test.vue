    ...
    <div class="dentistryServices">
      ...
      <div class="implantCase">
        ...
        <div class="implantCase-content">
          ...
          >
            <swiper-slide v-for="(implantCaseItem,implantCaseIndex) in 3" :key="implantCaseIndex">
          ...
          <div class="implantCase-content-line">
            <PageSwiperPointLine :latestNewsNum="3" :latestNewsCurrent="implantCaseCurrent" @changeLineCur="handleLineCur"></PageSwiperPointLine>
          </div>
        </div>
      </div>
      <ServiceCase />
