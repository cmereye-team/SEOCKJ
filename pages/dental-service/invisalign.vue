...
const stepData = {
  ...
  stepLists: [
    [
      {
        title: 'Step 1',
        textTh: '與牙醫諮詢及溝通過後，專人會為你的牙齒進行拍照、X光片、口腔內掃瞄或牙模套印來建立你的牙齒資料，亦會透過詳細講解令你明白整個療程過程及效果。',
        text: ''
      },
      {
        title: 'Step 2',
        textTh: '牙醫會與廠商方面溝通，為你建立專屬的3D矯齒治療方案。',
        text: ''
      },
      // {
      //   title: 'Step 3',
    ...
    [
      {
        title: 'Step 3',
        textTh: '廠商用3D電腦雷射列印科技製成一系列訂製牙箍，寄送至牙醫診所。我們會聯絡客人安排到診進行試戴並評估效果。客人需要每6至8星期複診，與牙醫跟進矯齒進度及取得新牙箍。',
        text: ''
      }
    ]
  ],
