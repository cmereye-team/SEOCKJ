  ...
  content: [
    ...
    },
    {
      ...
      list: [
        {
          type: 'defule',
          text: '深圳愛康健口腔醫院是唯一參與長者醫療券計劃的深圳口腔醫院。愛康健自1995年成立以來，超過29年一直專注為香港市民提供專業、貼心、全面的牙科醫療服務。愛康健在深圳擁有1間口腔醫院及12間門診診所，並致力於更新和升級醫療設備，引進最先進的設備和技術，以確保為客人提供安全、舒適、高效的醫療體驗。'
        }
      ]
    },
    {
